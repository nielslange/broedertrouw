...
$trips = array(
	...
	array(
		...
		'nl'      => array(
			...
			'excerpt'   => 'De laatste regatta van het seizoen, traditioneel vanuit de haven van Hoorn.',
			'includes'  => array( 'Maaltijden aan boord', 'Inschrijfgeld regatta' ),
			'excludes'  => array( 'Reis naar Hoorn', 'Dranken aan de bar' ),
		),
		'de'      => array(
			'title'     => 'Bontekoerace',
			'highlight' => 'Saisonabschluss ab Hoorn.',
			'excerpt'   => 'Die letzte Regatta der Saison, traditionell ab dem Hafen von Hoorn.',
			'includes'  => array( 'Mahlzeiten an Bord', 'Regatta-Startgeld' ),
			'excludes'  => array( 'Anreise nach Hoorn', 'Getränke an der Bar' ),
		),
	),
	...
	array(
		...
		'nl'      => array(
			...
			'excludes'  => array( 'Maaltijden en dranken', 'Reis naar Hoorn' ),
		),
		'de'      => array(
			...
			'excludes'  => array( 'Mahlzeiten und Getränke', 'Anreise nach Hoorn' ),
		),
	),
	array(
